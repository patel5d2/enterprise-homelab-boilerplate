...
from ...core.validation import validate_configuration, run_preflight_checks
    ...
    try:
        ...
        if config_dict.get('version') == 2:
            ...
            try:
                ...
                console.print("[yellow]⚠️  Loaded legacy configuration (consider migrating to v2)[/yellow]")
